...
<!-- skLearn-->
  ...
  <!-- Badge text -->
  <text x="45" y="25" font-family="Arial" font-size="16" fill="white">Scikit-learn</text>
</svg>
<!-- skLearn_end-->
